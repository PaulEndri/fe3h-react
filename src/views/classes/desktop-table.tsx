            ...
            <Table structured compact celled>
                <Table.Header>
                    <Table.Row>
                        ...
                        <Table.HeaderCell rowSpan="2" colSpan="3" textAlign="center">
                            Requirements
                        </Table.HeaderCell>
                    ...
                    {classes.map(job => {
                        return (
                            <Table.Row key={job.Name}>
                                ...
                                <Table.Cell positive={job.HP > 0 ? true : false} negative={job.HP < 0 ? true : false}>
                                    {job.HP}
                                </Table.Cell>
                                <Table.Cell positive={job.STR > 0 ? true : false} negative={job.STR < 0 ? true : false}>
                                    {job.STR}
                                </Table.Cell>
                                <Table.Cell positive={job.MAG > 0 ? true : false} negative={job.MAG < 0 ? true : false}>
                                    {job.MAG}
                                </Table.Cell>
                                <Table.Cell positive={job.SPD > 0 ? true : false} negative={job.SPD < 0 ? true : false}>
                                    {job.SPD}
                                </Table.Cell>
                                <Table.Cell positive={job.DEX > 0 ? true : false} negative={job.DEX < 0 ? true : false}>
                                    {job.DEX}
                                </Table.Cell>
                                <Table.Cell positive={job.LCK > 0 ? true : false} negative={job.LCK < 0 ? true : false}>
                                    {job.LCK}
                                </Table.Cell>
                                <Table.Cell positive={job.DEF > 0 ? true : false} negative={job.DEF < 0 ? true : false}>
                                    {job.DEF}
                                </Table.Cell>
                                <Table.Cell positive={job.RES > 0 ? true : false} negative={job.RES < 0 ? true : false}>
                                    {job.RES}
                                </Table.Cell>
                                <Table.Cell positive={job.CHA > 0 ? true : false} negative={job.CHA < 0 ? true : false}>
                                    {job.CHA}
                                </Table.Cell>
                            </Table.Row>
                        );
