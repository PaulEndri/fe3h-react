    ...
    return (
        <Segment color={color}>
            <Grid columns={2}>
                ...
                {personalSkill && <Grid.Row>
                    <Grid.Column width="16" textAlign="center" style={{display: 'flex', justifyContent: 'center'}}>
                        <Card fluid raised>
                            <Card.Content>
                                <Card.Header>
                                    {personalSkill.ability}
                                </Card.Header>
                                <Card.Meta>
                                    Unique Skill
                                </Card.Meta>
                            ...
                            <Tab panes={[
                                {
                                    ...
                                    render: () => <InitialGrowthTable type="smallint" growths={character.baseStats} />
                                },
                                {
