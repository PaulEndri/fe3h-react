                ...
                <Table collapsing striped structured selectable>
                    <Table.Header>
                        <Table.Row>
                            ...
                            <Table.HeaderCell rowSpan="2" width={2} singleLine textAlign="center">
                                Lost Items
                            </Table.HeaderCell>
                            <Table.HeaderCell colSpan="2" width={2} singleLine textAlign="center">
                                Recruitment
                            </Table.HeaderCell>
                            <Table.HeaderCell colSpan="3" width={3} singleLine textAlign="center">
                                Skills
                            </Table.HeaderCell>
                        </Table.Row>
                        <Table.Row>
                    ...
                    <Table.Body>
                        {house.students.map((student: ICharacter) => (
                            <Table.Row
                                ...
                                onClick={() => navAction(student.firstName.toLowerCase())}
                            >
                                <Table.Cell collapsing textAlign="center">
                                    <Image
                                        ...
                                        }/assets/characters/thumbnails/${student.firstName.toLowerCase()}.png`}
                                    />
                                </Table.Cell>
                                <Table.Cell textAlign="left">
                                    <List bulleted>
                                        {student.gift.map((g, i) => (
                                ...
                                <Table.Cell>
                                    {student.skillProficiencies.map(skill => (
                                        <Image
                                            ...
                                            width="25"
                                            inline
                                            src={`${process.env.PUBLIC_URL}/assets/icons/${skill
                                                .toLowerCase()
                                                .replace(" ", "-")}.png`}
                                        />
                                    ))}
