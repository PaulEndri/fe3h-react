...
function App() {
    return (
        <Container className="app-home-view" textAlign="center">
            ...
            <Header as="h1">Character Companion</Header>
            <Responsive maxWidth={Responsive.onlyMobile.maxWidth}>
                <p>Click on a faction to begin your journey to find gifts, stats, and more!</p>
                <Grid columns={2}>
                    {houses.map(house => (
                        <Grid.Column>
            ...
            <Responsive minWidth={Responsive.onlyMobile.maxWidth}>
                <Segment>
                    ...
                    <p>
                        This site/project is a fan project to provide a user friendly way to access all the data the
                        amazing community has amassed. The data was gathered from all the fine folk at the fe3h
                        subreddit, so go checkout the thread for more credit:
